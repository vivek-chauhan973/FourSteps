      ...
      <div className="   md:border xl:flex flex-col w-full gap-4  p-3 relative bg-white shadow h-auto ">
        <div className=" px-2  ">
          ...
          <ul className="  text-sm list-decimal md:px-5">
            <li>
              Format:: cleint typically include presentations, discussions,
            ...
            experience.
            <li>
              Accessibility: cleint can be accessed from anywhere with an
            ...
            <li>
              Cost-Effective: cleint eliminate travel and venue costs
          ...
          <div className=" font-semibold py-3">Benefits of cleint</div>
