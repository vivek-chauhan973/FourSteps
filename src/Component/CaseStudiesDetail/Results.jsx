        ...
        <div className="   md:border xl:flex flex-col w-full gap-4  p-3 relative bg-white shadow h-auto ">
          <div className=" px-2  ">
            ...
            <ul className="  text-sm list-decimal md:px-5">
              <li>
                Format:: Matrix typically include presentations, discussions,
              ...
              experience.
              <li>
                Accessibility: Matrix can be accessed from anywhere with an
                internet connection, making them convenient for both presenters
                and attendees.
              </li>
              <li>
                Recording: Many webinar platforms allow for sessions to be
                recorded and shared later, enabling attendees to review content
                or catch up if they missed the live event.
              </li>
              <li>
                Cost-Effective: Matrix eliminate travel and venue costs
            ...
            <div className=" font-semibold py-3">Benefits of Matrix</div>
