...
//   const progressData = [
//     { title: "Zoho Consulting", percentage: 92, color: "#F36B21" },
//     { title: "Website Devepoment", percentage: 80, color: "#48bb78" },
//     { title: "HUbSpot Consulting", percentage: 85, color: "#6573f5" }, // Adjust to your blue color
//     { title: "Digital Marketing", percentage: 50, color: "#48bb78" },
//   ];
...
//           <div className="md:w-1/2 w-full flex flex-col items-center space-y-8 p-5">
...
//                 <p className="mt-1 text-sm text-gray-700">{item.percentage}%</p>
//               </div>
//             ))}
//           </div>
//         </div>
...
const Team = () => {
  ...
  const progressData = [
    { title: "Zoho Consulting", percentage: 92, color: "#F36B21" },
    { title: "Website Development", percentage: 80, color: "#48bb78" },
    { title: "HubSpot Consulting", percentage: 85, color: "#6573f5" },
    { title: "Digital Marketing", percentage: 50, color: "#48bb78" },
  ];
  //  for team member
  const members = [
    ...
    <div className="container mx-auto">
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-6 md:px-8 lg:px-16 place-items-center">
          {members.map((member) => (
            <div
              key={member.id}
              className="w-full max-w-xs md:max-w-sm lg:max-w-md h-80 border rounded shadow-lg overflow-hidden"
            >
              <div className="w-full h-3/5 p-4">
                <img
                  className="w-full h-full rounded-md object-cover"
      ...
      <div className="w-full h-auto md:px-5 px-5 py-5">
        <div className="md:flex block justify-center items-start">
          ...
          {/* Circular Progress Bar Section */}
          <div className="md:w-1/2 w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:gap-10 gap-7 p-5">
            {progressData.map((item, index) => (
              <div key={index} className="flex flex-col items-center">
                <CircularProgressBar
                  percentage={item.percentage}
