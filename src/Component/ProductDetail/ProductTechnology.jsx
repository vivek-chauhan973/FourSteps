      ...
      <div className="   md:border xl:flex flex-col w-full gap-4  p-3 relative bg-white shadow h-auto ">
        <div className=" px-2  ">
          ...
          <ul className="  text-sm list-decimal md:px-5">
            <li>
              Format:: Technology typically include presentations, discussions,
            ...
            experience.
            <li>
              Accessibility: Technology can be accessed from anywhere with an
            ...
            <li>
              Cost-Effective: Technology eliminate travel and venue costs
          ...
          <div className=" font-semibold py-3">Benefits of Technology</div>
