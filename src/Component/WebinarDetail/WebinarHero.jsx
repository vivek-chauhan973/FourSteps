...
//       <div className="">
//         <div className="container mx-auto flex gap-5 text-white bg-[#243642] flex-col lg:flex-row items-start justify-between space-y-6 lg:space-y-0">
...
//           <div className="lg:w-2/5 flex pt-5 flex-col items-center">
//             <div className="relative h-64 bg-gray-500 mb-4 flex justify-center items-center">
//               <iframe
//                 className="w-full h-full" // Make the iframe fill the parent container
    ...
    <div className="container">
      <div className="">
        <div className="container mx-auto flex gap-5 text-white bg-[#10364f] flex-col lg:flex-row items-start justify-between space-y-6 lg:space-y-0">
          ...
          {/* Right section - Video */}
          {/* <div className="lg:w-2/5 flex pt-5 flex-col items-center order-1 lg:order-2">
