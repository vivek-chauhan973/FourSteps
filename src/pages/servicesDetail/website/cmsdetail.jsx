    ...
    <div className="container">
      ...
      >
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-xs sm:text-lg md:text-xl">
            Impress Your Customer with a Professional Website for Your Business
          </p>
      ...
      <div>
          ...
          <div className="grid  px-10 grid-cols-1 place-items-center md:grid-cols-2 overflow-hidden">
            <div className="order-2 md:order-1  sm:p-6">
              ...
              <p className="text-xs sm:text-base md:text-sm text-gray-600">
                Under this service, we design & develop business websites using
                WordPress. We use free and premium WordPress themes per your
                website’s feature requirements.
              </p>
            </div>
        ...
        <div className=" w-full sm:px-6 md:max-w-6xl mx-auto    mt-10">
          <div className="grid  px-10 grid-cols-1 place-items-center md:grid-cols-2 overflow-hidden">
            <div className="order-1 md:order-2  sm:p-6">
              <h2 className="text-md sm:text-xl md:text-2xl font-bold ">
                Hubspot CMS Website
              </h2>
            ...
            <div className="order-3 md:order-3 p-5 sm:p-6">
              <p className="text-xs md:hidden block sm:text-base md:text-sm text-gray-600">
                Under this service we set up Zoho Apps like Zoho CRM, Zoho
                Books, etc for your business, configuring them according to your
                needs, and customizing them to your brand and goals.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className=" w-full sm:px-6 md:max-w-6xl mx-auto   mt-10">
          <div className="grid  px-10 grid-cols-1 place-items-center md:grid-cols-2 overflow-hidden">
            <div className="order-2 md:order-1 sm:p-6">
              <h2 className="text-md sm:text-xl md:block hidden md:text-2xl font-bold ">
                Zoho Site
              </h2>
              <p className="text-xs sm:text-base md:text-sm text-gray-600">
                Under this service we set up Zoho Apps like Zoho CRM, Zoho
            ...
            <div className="order-1 md:order-2">
              <h2 className="text-md sm:text-xl md:text-2xl md:hidden text-center font-bold ">
                Zoho Site
              </h2>
              <img
                src="/image/132.png"
        ...
        <div className=" w-full sm:px-6 md:max-w-6xl mx-auto    mt-10">
          <div className="grid  px-10 grid-cols-1 place-items-center md:grid-cols-2 overflow-hidden">
            ...
            <div className="order-3 md:order-3 p-5 sm:p-6">
              <p className="text-xs md:hidden block sm:text-base md:text-sm text-gray-600">
                nder this service we set up Zoho Apps like Zoho CRM, Zoho Books,
                etc for your business, configuring them according to your needs,
                and customizing them to your brand and goals.
              </p>
            </div>
          </div>
        </div>
