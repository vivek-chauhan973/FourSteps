    ...
    <div className="container">
      ...
      >
        <div data-aos=" fade-up" className="relative z-10 text-center px-4">
          ...
          <p className="text-xs sm:text-lg md:text-xl">
            Skyrocket Your Success with Salesforce Excellence: Where Innovation
            Meets Precision!
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
            ...
            <p className="text-sm sm:text-base md:text-sm py-5 text-gray-600">
              ...
              customer relationship management software that offers a wide range
              of tools to help businesses streamline their Sales, Marketing,
              Customer service process and improve their performance. Four Steps
              Digital Consulting Pvt Ltd is a Salesforce Consulting service
              agency in Delhi NCR.
            </p>
        ...
        <div className="grid   grid-cols-1 place-items-center md:grid-cols-2 overflow-hidden">
          ...
          <div className="order-3 md:order-3 mt-4 sm:p-6">
            ...
            <div className=" md:hidden w-full mx-auto md:px-10 px-0 block ">
              ...
              Unleash the full power of Salesforce with our Optimization
              Services. Streamline processes, boost efficiency, and maximize ROI
              effortlessly. Elevate your business performance – start optimizing
              with us today!.
            </div>
          </div>
        </div>
            ...
            <div className="order-3 md:order-3  ">
              <div className="w-full text-xs hidden md:block sm:text-base  text-gray-600 mx-auto md:px-10 ">
                <p>
                  ...
                  with our Salesforce Integration Services. Our experts ensure a
                  seamless connection between Salesforce and your existing
          ...
          <div className="md:w-1/2 w-full h-auto md:pl-5 md:p-0 py-5 md:mt-0 mt-2">
            ...
            <div className="w-full mx-auto md:px-10 px-0">
              <p>
                ...
                your data, ensuring accuracy, integrity, and a smooth transition
                to Salesforce.
              </p>
            </div>
          </div>
      ...
      <div data-aos="fade-up" className=" my-5">
        <div className=" md:px-12 md:py-12 px-5 ">
          <h2 className=" font-bold  text-gray-400  text-md md:text-lg">
            Why us
          </h2>
          <h3 className=" md:text-3xl font-bold  text-md">
