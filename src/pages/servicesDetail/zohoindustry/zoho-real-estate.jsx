  ...
  return (
    <div className="container">
      ...
      >
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-xs sm:text-lg md:text-xl">
            Unlock Seamless Real Estate Management for Agents/Brokers. Simplify
            Your Operations with Our Comprehensive CRM Solution
          </p>
      ...
      {/* <div className=" px-4 w-full absolute  top-[35%] sm:top-[75%] md:top-[70%] lg:top-[65%] sm:px-6 md:px-20  ">
        <div className="flex flex-col md:flex-row bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          <div className="md:w-1/2 p-4 sm:p-6">
            <h2 className="text-md sm:text-xl md:text-2xl font-bold md:mb-3 mb-2">
      ...
      <div className="px-4 w-full sm:px-6 md:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
            <h2 className="text-md sm:text-xl md:text-3xl font-bold mb-2 md:mb-3">
      ...
      <div className=" text-center px-4">
        <h2 className="text-md sm:text-2xl md:text-3xl lg:text-3xl md:pt-16 pt-10 font-bold mb-2">
          Your Complete Real Estate Solution in One Platform
        </h2>
        <p className="text-xs sm:text-lg md:text-base">
          Discover a comprehensive real estate solution all under one roof. Our
          platform simplifies your real estate journey by seamlessly integrating
          lead management, property management, property visits, offers, and
          sales cycle management. Easily keep track of leads, efficiently manage
          your property portfolio, schedule visits effortlessly, and streamline
          the entire sales cycle. From initial contact to closing deals, our
          platform is designed to enhance your real estate experience.
        </p>
      </div>
      ...
      <div className=" my-6">
        <div className=" md:px-10 md:py-12 px-5 ">
          <h2 className=" font-bold md:mb-2  text-lg md:text-xl">
            ZOHO SERVICES
          </h2>
          <h3 className=" md:text-4xl font-bold  text-md">
              ...
              <ul>
                ...
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    ...
                    className="mt-1 text-indigo-500"
                  />
                  Diverse Listing Options: Facilitate various listing types such
                  as sale, purchase, Resale, Separate module for project
                  listings.
                </li>
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                ...
                <li className="mb-2 flex items-center gap-3">
                  ...
                  functionality to match properties with customer requirements,
                ...
                <li className="mb-2 flex items-center gap-3">
                  ...
                  update property booking statuses, ensuring real-time accuracy
                  and transparency.
                </li>
              </ul>
            </div>
            ...
            <div className="w-full mx-auto md:px-10 px-0">
              <ul>
                <li className="mb-2 flex items-center gap-3">
                  ...
                  properties to clients, facilitate site visits, manage offers,
                  and purchase agreements within the system.
                </li>
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    icon={faCheck}
                ...
                <li className="mb-2 flex items-center gap-3">
                  ...
                  transactions. Deal Stage Automation: Automate processes based
                  on deal
                </li>
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                ...
                <li className="mb-2 flex items-center gap-3">
                  ...
                  aligned with deal progression, enhancing overall efficiency in
                  managing real estate sales cycles.
                </li>
              </ul>
            </div>
          </div>
                ...
                <ul>
                  ...
                  <li className="mb-2 flex items-center gap-3">
                    <FontAwesomeIcon
                      ...
                      className="mt-1 text-indigo-500"
                    />
                    Invoicing Integration: Streamline invoicing processes within
                    the CRM for seamless financial management.
                  </li>
                  <li className="mb-2 flex items-center gap-3">
                    <FontAwesomeIcon
                      icon={faCheck}
                  ...
                  <li className="mb-2 flex items-center gap-3">
                    ...
                    bank-related information for efficient transaction handling.
                  </li>
                </ul>
              </div>
            </div>
