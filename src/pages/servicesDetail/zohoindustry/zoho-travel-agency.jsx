  ...
  return (
    <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
            <h2 className="text-md sm:text-lg md:text-2xl font-bold mb-2 md:mb-3">
              Elevate your real estate business with Zoho Real Estate CRMElevate
              your Travelling business with Zoho Travel Agency CRM
            </h2>
            <p className="text-sm sm:text-base md:text-sm py-5 text-gray-600">
              Our Zoho Travel Agency CRM is Tailored for Travel Agency. It helps
              to Streamline operations, manage tour package efficiently, and
              close trips seamlessly.Stay organized with centralized data,
      ...
      <div className=" text-center px-4">
        <h2 className="text-md sm:text-2xl md:text-3xl lg:text-4xl md:pt-16 pt-10 font-bold mb-2">
        ...
        <p className="text-xs sm:text-lg md:text-base">
          ...
          effortlessly, and streamline the entire trip management. From initial
          contact to closing trip, our platform is designed to enhance your
          travel business.
        </p>
      </div>
            ...
            <div className="w-full mx-auto md:px-10 px-0">
              <ul>
                <li className="mb-2 flex items-center gap-3">
                  ...
                  various sources including websites, chatbots, and social media
                  platforms.
                </li>
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    ...
                    className="mt-1 text-indigo-500"
                  />
                  Automated Task Assignment: Effortlessly assign tasks based on
                  lead status, streamlining workflows and enhancing efficiency.
                </li>
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    icon={faCheck}
                ...
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    ...
                    className="mt-1 text-indigo-500"
                  />
                  Lead Assignment rule: Automated lead assignment to appropriate
                  agents or teams and much more.
                </li>
              </ul>
            </div>
          </div>
              ...
              <div className="w-full text-xs hidden md:block sm:text-base  text-gray-600 mx-auto md:px-10 ">
                <ul>
                  ...
                  <li className="mb-2 flex items-center gap-3">
                    ...
                    members for effective coordination during trip planning and
                    execution.
                  </li>
                </ul>
              </div>
              ...
              <ul>
                ...
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    ...
                    className="mt-1 text-indigo-500"
                  />
                  Real-Time Availability: Provide real-time availability status
                  for flights, hotels, and transportation options.
                </li>
                ...
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    ...
                    className="mt-1 text-indigo-500"
                  />
                  Booking Confirmation: Automate booking confirmation processes
                  and notifications.
                </li>
              </ul>
            </div>
                ...
                <ul>
                  <li className="mb-2 flex items-center gap-3">
                    <FontAwesomeIcon
                      ...
                      className="mt-1 text-indigo-500"
                    />
                    Individual Vouchers: Generate separate customer vouchers for
                    flights, hotels, and transportation services.
                  </li>
                  <li className="mb-2 flex items-center gap-3">
                    <FontAwesomeIcon
                      icon={faCheck}
                ...
                <ul>
                  <li className="mb-2 flex items-center gap-3">
                    <FontAwesomeIcon
                      ...
                      className="mt-1 text-indigo-500"
                    />
                    Payment Details: Capture and manage customer payment details
                    and vendor payment details securely.
                  </li>
                  <li className="mb-2 flex items-center gap-3">
                    <FontAwesomeIcon
                      icon={faCheck}
              ...
              <ul>
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    ...
                    className="mt-1 text-indigo-500"
                  />
                  Custom Reports and Dashboard: Provide a range of customizable
                  reports and dashboards for tracking performance metrics.
                </li>
                <li className="mb-2 flex items-center gap-3">
                  <FontAwesomeIcon
                    icon={faCheck}
