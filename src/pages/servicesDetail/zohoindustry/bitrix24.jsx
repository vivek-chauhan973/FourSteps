    ...
    <div className="container">
      ...
      >
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-xs sm:text-lg md:text-xl">
            Where innovation meets implementation, and your business transforms
            with seamless collaboration and unparalleled efficiency.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
            ...
            <p className="text-sm sm:text-base md:text-sm py-5 text-gray-600">
              ...
              Services – your strategic partner in harnessing the full potential
              of Bitrix24. From seamless implementation to tailored solutions,
              our agency is committed to elevating your collaboration,
              communication, and productivity, bringing the power of Bitrix24 to
      ...
      <div className=" my-6">
        <div className=" md:px-10 md:py-12 px-5 ">
          ...
          <h3 className=" py-5 font-bold  text-md">
          ...
          <div className="md:w-1/2 w-full h-auto md:pl-5 md:p-0 py-5 md:mt-0 mt-2">
            ...
            <div className="w-full mx-auto md:px-10 px-0">
              <p>
                ...
                preserving data integrity and ensuring a hassle-free transition.
                Our integration services enable the connection of Bitrix24 with
                other tools and systems, streamlining data flow and enhancing
                overall efficiency.
              </p>
            </div>
          </div>
          ...
          <div className="md:w-1/2 w-full h-auto md:pl-5 md:p-0 py-5 md:mt-0 mt-2">
            ...
            <div className="w-full mx-auto md:px-10 px-0">
              <p>
                ...
                Additionally, our support services are available to address any
                queries or issues promptly.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:p-10 cursor-pointer">
          {businesses.slice(0, displayCount).map((business, index) => (
            ...
            >
              ...
              />
              <p className="text-center w-full font-bold h-1/3">
                {business.name}
              </p>
            </div>
          ))}
