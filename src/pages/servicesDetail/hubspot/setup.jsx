        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center mb-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs">
                Leverage the full power of HubSpot’s tools and features for your
                goals.
              </p>
            </div>
          </div>
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6  px-4  items-center">
          <div>
            ...
            <p className="md:py-4 py-2 text-xs md:text-sm text-gray-600">
              ...
              fully leverage the capabilities of HubSpot for growth.
            </p>
          </div>
      ...
      >
        <div className="text-center px-4">
          <h1 className="text-sm md:text-xl uppercase font-bold mb-2">
            Need Custom Zoho <span className="text-blue-500">Solutions?</span>
          </h1>
