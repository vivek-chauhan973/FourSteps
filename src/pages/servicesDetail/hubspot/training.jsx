      ...
      <div className="grid grid-cols-1 mt-5 md:grid-cols-2 bg-gray-200 gap-6 p-6">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-start mb-1">
            ...
            <div className="flex-1 py-1">
              ...
              <p className="text-xs">
                ...
                keep businesses informed about the latest trends, features, and
                best practices, ensuring they stay ahead of the curve.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start mb-2">
            ...
            />
            <div className="flex-1">
              <h3 className="text-md font-semibold">competitive Advantage </h3>
              <p className="text-xs">
      ...
      <div className=" bg-gray-300">
        ...
        <div className="  flex justify-center py-4 w-full ">
          <div className="grid gap-5 w-72  md:w-1/2 md:grid-cols-2  lg:grid-cols-2">
            ...
            >
              <h2 className="text-xl font-semibold mb-4">Inbound Consulting</h2>
