    ...
    <div className="container">
      ...
      >
        <div data-aos=" fade-up" className="relative z-10 text-center px-4">
          <h1 className="text-md sm:text-2xl md:text-3xl lg:text-5xl md:pt-16 pt-10 font-bold mb-2">
      ...
      <div data-aos="fade-up" className="px-4 w-full sm:px-6 md:px-20">
        <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
            <h2 className="text-md sm:text-lg md:text-2xl font-bold mb-2 md:mb-3">
            ...
            <p className="text-sm sm:text-base md:text-sm py-5 text-gray-600">
              ...
              is one of the best Search Engine Optimization(SEO) agency in Delhi
              NCR. Our SEO expert team will help to rank your website on Google
              search result page.
            </p>
      ...
      <div data-aos="fade-up" className=" my-6">
        <div className=" md:px-10 md:py-12 px-5 ">
          <h2 className=" font-bold md:mb-2  text-gray-400 text-sm md:text-lg">
            SEO SERVICES
          </h2>
          ...
          <h3 className=" py-4  text-xs md:text-lg">
            We offer local & national SEO services for small business for Google
            search engine. Our search engine optimization(SEO) services include
          </h3>
        </div>
        <div className="md:flex md:px-10 px-5">
          ...
          <div className="md:w-1/2 w-full h-auto md:pl-5 md:p-0 py-5 md:mt-0 mt-2">
            ...
            <div className="md:px-10  mb5">
              <h2 className="md:text-3xl  text-lg md:text-start text-center font-bold md:mb-3 capitalize">
                SEO Audit
              </h2>
            </div>
            ...
            <div className=" flex justify-center text-center text-sm mx-auto md:px-10 px-0">
              <p>
                ...
                audit, Local SEO Audit and Backlinks audit. Google Ad Format
                include – Google search ad/Paid Search Ad, Google Display
                Ad/Banner Ad, YouTube Ad/Video Ad, Google Shopping Ad and Google
                App Ad
              </p>
            </div>
          </div>
            ...
            <div className="order-3 md:order-3">
              <div className="w-full text-xs hidden md:block sm:text-base text-gray-600 mx-auto md:px-10 ">
                <p>
                  ...
                  optimization, Local link building.Google Ad Format include –
          ...
          <div className="md:w-1/2 w-full h-auto md:pl-5 md:p-0 py-5 md:mt-0 mt-2">
            ...
            <div className="w-full mx-auto md:px-10 px-0">
              <p>
                ...
                business’ website ranking and visibility on Google search result
                page, so you website are visible on google search page when any
                one search something relate to your products & services. Our
                small business SEO include keyword research, On page SEO,
                Technical SEO, SEO Content creation, Quality link building and
                Measuring & reporting.
              </p>
            </div>
          </div>
      ...
      <div data-aos="fade-up" className=" w-full sm:px-6 py-4 mx-auto    mt-10">
        <div className="grid   grid-cols-1 place-items-center md:grid-cols-2 overflow-hidden">
          <div className="order-1 md:order-2  ">
            <h2 className="md:text-3xl my-4  text-xl md:text-start text-center font-semibold md:mb-3 capitalize">
              Ecommerce Seo
            ...
            <div className="order-3 md:order-3  ">
              <div className="w-full text-xs hidden md:block sm:text-base  text-gray-600 mx-auto md:px-10 ">
                <p>
                  ...
                  more visible in the search engine results pages (SERPs). When
                  anyone search related to your products that you sell. Our
                  ecommerce SEO include Ecommerce Keyword Research, Ecommerce
                  website architecture, Ecommerce on page SEO, Technical SEO,
                  Ecommerce content marketing and ecommerce link building
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="md:w-1/2 w-full h-auto md:pl-5 md:p-0 py-5 md:mt-0 mt-2">
            ...
            <div className=" flex justify-center text-center text-sm mx-auto md:px-10 px-0">
              <p>
                ...
                backlinks. Backlinks improve your website authority that help to
                improve your ranking in the search engine results pages (SERPs).
                Our link building services include Keyword Analysis/Strategy,
                Competitor Analysis, Backlink audit, Guest posts, PPT link
                building, Image link building and Broken ink building.
              </p>
            </div>
          </div>
            ...
            <div className="order-3 md:order-3">
              <div className="w-full text-xs hidden md:block sm:text-base text-gray-600 mx-auto md:px-10 ">
                <p>
                  ...
                  Google Play or Apple App Store. More visibility of your app in
                  app store means get more potential customers. Our App store
                  optimization services include keyword optimization, conversion
                  rate optimization, ASO content, ASO analysis and ASO support.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="px-10">
          <h1 className="md:text-3xl mx-auto text-xl text-white font-bold py-5">
            Why Four Steps Digital For SEO Services?
          </h1>
          <p className="text-sm">
            Four Steps Digital Consulting Pvt Ltd (4steps Marketing) has helped
            many small business owners achieve their targeted ROI. We will take
            care of everything, from keyword research to making ad creatives and
      ...
      <div
        data-aos="fade-up"
        className=" w-full my-10 sm:px-6 md:max-w-6xl mx-auto  bg-gray-200  py-10"
      >
      ...
      <div className="container mx-auto mt-3 py-7  grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="col-span-1 md:col-span-2 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-[15px] leading-6">
            A Few of top questions generally our clients asked us regarding SEO
            Services
          </p>
