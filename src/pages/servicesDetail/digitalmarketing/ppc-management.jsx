    ...
    <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
            ...
            <p className="text-sm sm:text-base md:text-sm py-5 text-gray-600">
              Four Steps Digital Consulting Pvt Ltd (4steps Marketing) is a PPC
              Management agency in Delhi NCR. Whether you want to increase
              conversions, website traffic or instant lead generation, our PPC
              management services will help you achieve your goals and maximize
              your ROI.
            </p>
      ...
      <div data-aos="fade-up" className=" my-6">
        <div className=" md:px-10 md:py-12 px-5 ">
          ...
          <h3 className=" md:text-3xl  font-semibold  text-sm">PPC Services</h3>
          <h3 className=" py-4  text-xs md:text-lg">
            We offer PPC services for different platforms like Google Ad, Social
            media , Amazon and Taboola. Our Pay – Per – Click (PPC) services
            include
          </h3>
        </div>
        ...
        <div className="md:flex md:px-10 px-5">
          ...
          <div className="md:w-1/2 w-full h-auto md:pl-5 md:p-0 py-5 md:mt-0 mt-2">
            ...
            <div className="w-full mx-auto md:px-10 px-0">
              <p>
                We offer Facebook advertising services that include Facebook Ad
                account setup, Facebook ad campaign setup, A/B testing,
                Remarketing, Campaign optimization, Landing page creation &
                optimization etc. for all format of Facebook Ad. Facebook Ad
                Formats include – Image Ad, Video Ad, Carousel Ad, Slideshow Ad,
                Collection Ad, Playables Ad, Messenger Ad and Stories Ad Google
                Ad Format include – Google search ad/Paid Search Ad, Google
                Display Ad/Banner Ad, YouTube Ad/Video Ad, Google Shopping Ad
                and Google App Ad
              </p>
            </div>
          </div>
        ...
        <div className="grid   grid-cols-1 place-items-center md:grid-cols-2 overflow-hidden">
          <div className="order-1 md:order-2  ">
            ...
            <div className="order-3 md:order-3  ">
              <div className="w-full text-xs hidden md:block sm:text-base  text-gray-600 mx-auto md:px-10 ">
                <p>
                  We offer LinkedIn. advertising services that include LinkedIn
                  Ad account setup, LinkedIn ad campaign setup, A/B testing,
                  Remarketing, Campaign optimization, Landing page creation &
                  optimization etc. for all format of LinkedIn Ad. LinkedIn Ad
                  formats include – Single image ad, Carousel image ad, Video
                  ad, Text ad, Spotlight ad, Message ad, Conversation ad and
                  Event ad Google Ad Format include – Google search ad/Paid
                  Search Ad, Google Display Ad/Banner Ad, YouTube Ad/Video Ad,
                  Google Shopping Ad and Google App Ad
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto mt-3 py-7  grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div className="col-span-1 md:col-span-2 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-[15px] leading-6">
            A Few of top questions generally our clients asked us regarding PPC
            Services
          </p>
