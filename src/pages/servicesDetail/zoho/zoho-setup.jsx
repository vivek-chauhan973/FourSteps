    ...
    <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  overflow-hidden">
          <div className="md:order-1 p-4 sm:p-6">
            ...
            <p className="text-orange-400 text-sm">
              Transform your business with Zoho Setup & Implementation Services,
              revolutionizing workflows for heightened productivity and success!
            </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-100  gap-6 p-6 ">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className=" text-sm">
            Professionals ensure that Zoho applications are configured optimally
            to maximize their capabilities and benefits for the business. This
            includes setting up workflows, integrations, and automations to
      ...
      <div
        className="w-full mt-6 sm:px-6 md:max-w-6xl mx-auto bg-gray-100 shadow-lg rounded-lg py-10"
