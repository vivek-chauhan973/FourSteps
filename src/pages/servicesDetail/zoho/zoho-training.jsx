    ...
    <div className="container">
      ...
      <div className="grid grid-cols-1 mt-5 md:grid-cols-2 bg-gray-200 gap-6 p-6 ">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mb-1 text-sm">
            Tailored training addresses specific business needs, enabling users
            to leverage Zoho’s features effectively for their unique
            requirements.
          </p>
          ...
          <p className=" text-sm">
            Regular training ensures users stay updated with the latest features
            and updates in Zoho, maximizing the platform’s effectiveness.
          </p>
        </div>
      </div>
