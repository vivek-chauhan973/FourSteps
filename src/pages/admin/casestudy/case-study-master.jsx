  ...
  return (
      ...
      <AdminLayout>
        ...
        <div className="p-4 mb-5 rounded-md bg-white shadow-[0_0px_10px_-3px_rgba(0,0,0,0.3)]  border-l-2 border-teal-600">
          <p className="text-base font-semibold mb-2">Case Study Promo Banner</p>
          <div className="p-4">
        ...
        <div className=" grid grid-cols-1 xl:grid-cols-2 gap-5 rounded">
          {isUpdating&&<CaseStudySeoPromo selectedPromoId={selectedPromoId} />}
        </div>
      </AdminLayout>
