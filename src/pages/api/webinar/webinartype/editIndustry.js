...
import WebinarType from "@/models/admin/webinar/webinartype/WebinarType";
...
export default async function handler(req, res) {
  ...
  if (req.method === "PUT") {
    ...
    try {
      const updatedIndustry = await WebinarType.findByIdAndUpdate({_id:id},{$set:{name}},{upsert:true});
