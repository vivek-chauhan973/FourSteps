        ...
        <div className="container">
            <div className="w-100vw  h-auto">
                <div
                    ...
                    style={{ backgroundImage: 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTS6Cbkx9E9yIP8ihE6TSSoIZ0jPavCEVnoA&s")' }} // Update with your image path
                >
                    <div className="absolute inset-0 bg-black opacity-50"></div>
                    <div className="relative z-10 text-center px-4">
                        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2">Welcome To Our Contact Page</h1>
                        <p className="text-sm sm:text-lg">For explorers everywhere.</p>
                    </div>
                </div>
                <div className='md:p-10 p-5'>
                    <h3 className='md:text-4xl text-2xl font-semibold text-center mb-5'>Get In <span className='text-gradient'>Touch</span></h3>
                    <p className=' leading-6 md:text-base text-sm text-center'>We will contact again after receive your request in 24h</p>
                    <div className="md:flex items-center justify-around bg-white md:shadow-md md:rounded-full xl:py-10 md:py-3 px-6 xl:mt-16 md:mt-14  mt-5 md:border">
                        <div className="flex items-center space-x-2">
                            <img src="/path/to/email-icon.png" alt="Email Icon" className="w-6 h-6" />
                            <span className="text-base font-medium">info@4stepsdigital.com</span>
                        </div>
                        <div className="md:border-l h-8 mx-4"></div>
                        <div className="flex items-center space-x-2">
                            <img src="/path/to/location-icon.png" alt="Location Icon" className="w-6 h-6" />
                            <span className="text-base font-medium ">T-3 A-1113, NX Byte, NX One Plot No. - 17, <br /> Sector - Tech Zone IV, Greater Noida West, 201310</span>
                        </div>
                        <div className="md:border-l h-8 mx-4"></div>
                        <div className="flex items-center space-x-2">
                            <img src="/path/to/phone-icon.png" alt="Phone Icon" className="w-6 h-6" />
                ...
                <div className=" md:p-10 p-5 md:gap-10">
                    <div className='rounded-md w-full xl:h-[500px] md:h-[400px] h-[250px]'>
                        <iframe className='rounded-md object-cover'
                            src={mapSrc}
                            width="100%"
                            height="100%"
                            allowfullscreen=""
                    ...
                    <div class="md:mt-10 mt-7 bg-zinc-100 rounded-md shadow-md grid place-items-center">
                        <div className='xl:w-2/3 w-full  xl:py-16 xl:p-0 md:p-7 p-5'>
                            <h3 class="xl:text-2xl md:text-xl text-lg capitalize text-gray-800 font-bold md:mb-4 mb-2 text-center">Feel Free To Contact Us</h3>
                                    ...
                                    <div className="md:py-3 py-2">
                                        <div>
                                            ...
                                            <input type="text" id="name" name="name" required placeholder='Enter Your Name'
                                                class="w-full bg-white rounded-full border border-gray-400 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-900 py-1 px-4 leading-8 transition-colors duration-200 ease-in-out " />
                                        </div>
                                    </div>
                                    <div className="md:py-3 py-2">
                                        <div>
                                ...
                                <div className='md:grid grid-cols-2 gap-5'>
                                    ...
                                    <div className="md:py-3 py-2">
                                        <div>
                                            ...
                                            <input type="text" id="text" name="text" placeholder='Your website (optional)'
                                                class="w-full bg-white rounded-full border border-gray-400 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-900 py-1 px-4 leading-8 transition-colors duration-200 ease-in-out " />
                                        </div>
                                    </div>
                                </div>
                                <div className="md:py-3 py-2">
                                    <div>
                                        ...
                                        <select id="services" name="services"
                                            ...
                                            <option value="Hubsport Services">Hubsport Services</option>
                                ...
                                <div className="md:py-3 py-2">
                                    <div>
                                        ...
                                        <textarea id="message" name="message" placeholder='Your Message.....'
                                            class="w-full bg-white rounded-lg border border-gray-400 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 h-32 text-base outline-none text-gray-900 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out ">
                                        </textarea>
                                    </div>
                                </div>
